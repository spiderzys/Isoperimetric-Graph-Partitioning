...
if l == 1
    ...
    for i = 1:r
        for j = 1:c
            t = i+(j-1)*r;
            %
            weight(t,1) = exp((-B)*(((im2(i+1,j+1,1)-im2(i+1,j,1))^4+(im2(i+1,j+1,2)-im2(i+1,j,2))^4+(im2(i+1,j+1,3)-im2(i+1,j,3))^4))^(1/2));
            weight(t,2) = exp((-B)*(((im2(i+1,j+1,1)-im2(i,j+1,1))^4+(im2(i+1,j+1,2)-im2(i,j+1,2))^4+(im2(i+1,j+1,3)-im2(i,j+1,3))^4))^(1/2));
            weight(t,3) = exp((-B)*(((im2(i+1,j+1,1)-im2(i+1,j+2,1))^4+(im2(i+1,j+1,2)-im2(i+1,j+2,2))^4+(im2(i+1,j+1,3)-im2(i+1,j+2,3))^4))^(1/2));
            weight(t,4) = exp((-B)*(((im2(i+1,j+1,1)-im2(i+2,j+1,1))^4+(im2(i+1,j+1,2)-im2(i+2,j+1,2))^4+(im2(i+1,j+1,3)-im2(i+2,j+1,3))^4))^(1/2));
        end
    end
end
